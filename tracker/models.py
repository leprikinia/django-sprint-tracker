...
class Sprint(models.Model):
    ...
    status = models.IntegerField(choices=SprintStatusChoices.choices, default=SprintStatusChoices.PLANNED)
...
class Task(models.Model):
    ...
    description = models.TextField(blank=True)
    status = models.IntegerField(choices=TaskStatusChoices.choices, default=TaskStatusChoices.TO_DO)
    priority = models.IntegerField(choices=TaskPriorityChoices.choices, default=TaskPriorityChoices.MEDIUM)
